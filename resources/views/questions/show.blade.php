                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            <div class="d-flex flex-column vote-controls">
                                ...
                                <form id="up-vote-question-{{ $question->id }}" method="post" action="/questions/{{ $question->id }}/votes" style="display: none;">
                                    @csrf
                                ...
                                <form id="down-vote-question-{{ $question->id }}" method="post" action="/questions/{{ $question->id }}/votes" style="display: none;">
                                    @csrf
                                    <input type="hidden" name="vote" value="-1">
                                </form>

                                <a title="Click to mark as favourite question (click again to undo)"
                                   class="favourite mt-2 {{ Auth::guest() ? 'off' : ($question->is_favourite ? 'favourited' : '') }}"
                                ...
                                <form id="favourite-question-{{ $question->id }}" method="post" action="/questions/{{ $question->id }}/favourites" style="display: none;">
                                    @csrf
